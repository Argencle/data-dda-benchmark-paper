...
!     ..
      ...
      STOPTYPE = IPAR(9)
!*** diagnostic
!      write(0,*)'cgcommon ckpt 1'
!      write(0,*)'  scsetrhsstop: loclen=',loclen
...
!*** diagnostic
!         write(0,*)'cgcommon ckpt 2'
!         write(0,*)'  about to call pscnrm for array B'
!***
...
!*** diagnostic
            write(0,*)'cgcommon ckpt 3'
!***
          ELSE
!*** diagnostic
            write(0,*)'cgcommon ckpt 4'
!***
            CALL MATVEC(WRK,XOLD,IPAR)
            CALL CAXPY(LOCLEN,-CONE,XOLD,1,RTRUE,1)
!*** diagnostic
            write(0,*)'cgcommon ckpt 5'
!***
          END IF
        ELSE IF (CNVRTX==1) THEN
!*** diagnostic
          write(0,*)'cgcommon ckpt 6'
!***
          CALL TMATVEC(X,XOLD,IPAR)
          CALL MATVEC(XOLD,WRK,IPAR)
          CALL CAXPY(LOCLEN,-CONE,WRK,1,RTRUE,1)
!*** diagnostic
          write(0,*)'cgcommon ckpt 7'
!***
        ELSE
!*** diagnostic
          write(0,*)'cgcommon ckpt 8'
!***
          CALL MATVEC(X,WRK,IPAR)
          CALL CAXPY(LOCLEN,-CONE,WRK,1,RTRUE,1)
!*** diagnostic
          write(0,*)'cgcommon ckpt 9'
!***
        END IF
      END IF
...
!                 does not need to be hardwired here).
...
!     ..
!*** diagnostic
!      write(0,*)'cgcommon ckpt 3: loclen=',loclen
!***
...
! produces bad code when optimizing code written by Lawson.
...
!***********************************************************************
!*** diagnostic
!      write(0,*)'cgcommon ckpt 4: n=',n,' incx=',incx
!***
      SUM=0._WP
      DO I=1,N
         J=1+(I-1)*INCX
