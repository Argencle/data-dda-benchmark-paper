...
JOBS = [
    # GPU 2000 Ada
    (
        "datas/logs_GPU_2000Ada/outputs/adda_gpu_results.csv",
        "datas/logs_GPU_2000Ada/adda_gpu_results_sorted.csv",
        ["N", "solver", "exe", "rep"],
    ),
    (
        "datas/logs_GPU_2000Ada/outputs/ifdda_gpu_results.csv",
        "datas/logs_GPU_2000Ada/ifdda_gpu_results_sorted.csv",
        ["N", "OMP", "exe", "rep"],
    ),
    # GPU cluster
    (
        "datas/logs_GPU_cluster/outputs/adda_gpu_results.csv",
        "datas/logs_GPU_cluster/adda_gpu_results_sorted.csv",
        ["N", "solver", "exe", "partition", "rep"],
    ),
    (
        "datas/logs_GPU_cluster/outputs/ifdda_gpu_results.csv",
        "datas/logs_GPU_cluster/ifdda_gpu_results_sorted.csv",
        ["N", "exe", "partition", "rep"],
    ),
    # MPI cluster
    (
        "datas/logs_MPI_cluster/outputs/adda_results.csv",
        "datas/logs_MPI_cluster/outputs/adda_results_sorted.csv",
        ["N", "NP", "FFT", "rep"],
    ),
    (
        "datas/logs_MPI_cluster/outputs/ifdda_results.csv",
        "datas/logs_MPI_cluster/outputs/ifdda_results_sorted.csv",
        ["N", "OMP", "rep"],
    ),
    (
        "datas/logs_MPI_cluster/outputs/ddscat_results.csv",
        "datas/logs_MPI_cluster/outputs/ddscat_results_sorted.csv",
        ["N", "OMP", "FFT", "rep"],
    ),
    # MPI laptop
    (
        "datas/logs_MPI_laptop/outputs/adda_results.csv",
        "datas/logs_MPI_laptop/adda_results_sorted.csv",
        ["N", "NP", "FFT", "rep"],
    ),
    (
        "datas/logs_MPI_laptop/outputs/ifdda_results.csv",
        "datas/logs_MPI_laptop/ifdda_results_sorted.csv",
        ["N", "OMP", "rep"],
    ),
    (
        "datas/logs_MPI_laptop/outputs/ddscat_results.csv",
